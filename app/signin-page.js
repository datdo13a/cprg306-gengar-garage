                ...
                {user ? (
                    <div className="bg-white rounded-3xl shadow-2xl p-8 border-2 border-purple-200">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600 text-lg font-medium">{user.displayName}</p>
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl p-8 border-2 border-purple-200">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600 text-lg">Your Pokémon Card Collection</p>
                        </div>

                        {/* Sign In Section */}
                        <div className="space-y-6">
                            <div className="text-center">
                                <p className="text-gray-700 mb-6">Sign in to manage your collection, create listings, and more!</p>
                            </div>
